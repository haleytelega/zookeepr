...
const PORT = process.env.PORT || 3001; //Tell Heroku to use that port
const app = express();
...
function findById(id, animalsArray){ //takes in the id and array of animals and returns a single animal object
...
function createNewAnimal(body, animalsArray) {
    ...
    fs.writeFileSync(
        ...
        //null means don't edit the existing data, 2 means to leave white space
        );
...
app.get('/api/animals', (req, res) => { //route
    let results = animals;
    if (req.query) {
